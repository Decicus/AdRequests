...
return [
    ...
    'fields' => [
        ...
        'other' => [
            'name' => 'Q1: Give us a title/name for your request.',
            'description' => 'Q2: Please provide as much detail about your request as possible.'
        ],
        'video' => [
            'name' => 'Q1: What is the video title/name?',
            'url' => 'Q2: What is the video\'s URL?',
            'owner' => 'Q3: Is the video made by you?',
            'description' => 'Q4: Please give us a small description about this video, including why you want to post it on /r/Twitch.'
        ],
        'web' => [
            'name' => 'Q1: What is the name of the tool?',
            'url' => 'Q2: What is the URL for your tool?',
            'description' => 'Q3: Please give us a small description of your service.',
            'user_data' => 'Q4: What user data will you require?',
            'api' => 'Q5: Do you require data from the Twitch API?',
            'api_data' => 'Q5.1: What user data will you store from the Twitch API?',
